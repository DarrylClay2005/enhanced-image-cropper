...
class EnhancedImageCropper:
    ...
    def setup_right_panel(self):
        ...
        ctk.CTkLabel(adj_frame, text="🎨 Adjustments", font=ctk.CTkFont(size=16, weight="bold")).pack(pady=5)
        ...
        ctk.CTkLabel(batch_frame, text="📦 Batch Operations", font=ctk.CTkFont(size=16, weight="bold")).pack(pady=5)
    ...
    def apply_template(self, template_name):
        ...
        if template_name in self.templates:
            ...
            # Convert to display coordinates if image is displayed
            if self.displayed_image:
...
def print_info():
  ...
  |___|_|  |_/_/   \_\____|_____|  \____|_| \_\___/|_|   |_|   |_____|_| \_\
    ...
    print("✅ Professional crop templates (Instagram, YouTube, etc.)")
    print("✅ Advanced image adjustments (brightness, contrast, saturation)")
    print("✅ Professional filters and effects")
    print("✅ Smart auto-enhancement with CLAHE")
    print("✅ Noise reduction algorithms")
    print("✅ Histogram equalization")
    print("✅ Automatic color balance")
    print("✅ Batch processing for multiple images")
    print("✅ Zoom and pan functionality")
    print("✅ Undo/Redo system with 20-level history")
    print("✅ Export with quality settings")
    print("✅ Transform operations (rotate, flip)")
    print("=" * 80)
